...
/**
 * Generated class for the CincodiasPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-cincodias',
  templateUrl: 'cincodias.html',
})
export class CincodiasPage {
  items = [];
  itemsdos = [];
  itemstres = [];
  itemscuatro = [];
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad CincodiasPage');
  }
